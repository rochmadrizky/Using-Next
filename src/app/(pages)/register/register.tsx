      ...
      <div className="w-full max-w-xs border p-8 rounded-lg">
        ...
        <form action="">
          <div className="mb-6">
            ...
            <input
              type="email"
              className=" text-sm border rounded w-full py-2 px-3 text-gray-700"
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                type={tampilanPassword ? "text" : "password"}
                className=" text-sm border rounded w-full py-2 px-3 text-gray-700"
                placeholder="****"
              />
              <button
                type="button"
                onClick={() => tombolBukaTutupPassword("password")}
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                type={tampilanConfirmPassword ? "text" : "password"}
                className=" text-sm border rounded w-full py-2 px-3 text-gray-700"
                placeholder="****"
              />
              <button
                type="button"
                onClick={() => tombolBukaTutupPassword("confirmPassword")}
                className="absolute inset-y-0 right-0 px-4 py-1 focus:outline-none"
              >
                {tampilanConfirmPassword ? (
                  <IconEye className="text-gray-400" />
                ) : (
                  <IconEyeOff className="text-gray-400" />
                )}
          ...
          <div className="flex items-center justify-center my-3 gap-1">
            <p className="text-sm text-gray-700">You have account?</p>
            <Link href="/login">
              <p className="text-blue-500 font-semibold text-sm">Login</p>
            </Link>
          </div>
        </form>
      </div>
